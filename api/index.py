...
settings.TitleId = "FF025"
settings.SecretKey = "W3HF6KF6M71XGTSPTKSQAOFZGPFNBAIPIU7DXTHWPBJIYK5K43"
settings.ApiKey = "OC|9464422760283094|e64f38666b1acc0c6672a6b8a83f1fee""
...
def titled_data():
    return jsonify({"MOTD": "<color=ORANGE>WELCOME TOO PROJECT UNTITLED</color>\n\n<color=red>UPDATE: NOWRUZ 2024, HAVE AN UPDATE THAT YOU WANT? REQUEST IT IN THE DISCORD!</color>\n\n<color=blue>DISCORD: https://discord.gg/Rabp6Pk6DX</color>\n\n<color=orange>CREDITS: HARMONY</color>"})
