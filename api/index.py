...
class GameInfo:
    def __init__(self):
        self.TitleId: str = "FF025"  # Playfab Title Id
        self.SecretKey: str = "W3HF6KF6M71XGTSPTKSQAOFZGPFNBAIPIU7DXTHWPBJIYK5K43"  # Playfab Secret Key
        self.ApiKey: str = "OC|9464422760283094|e64f38666b1acc0c6672a6b8a83f1fee"  # App Api Key (Oculus/Graph API)
